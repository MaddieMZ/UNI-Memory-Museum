...
GLfloat vertices[] =
{
	// COORDENADAS COLORES COORDENADASPARA LA TEXTURE
...
int main()
{
	...
	unsigned char* bytes = stbi_load("yoshii.png", &widthImg, &heightImg,
		&numColCh, 0);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		shaderProgram.Activate();
		//Control de la Rotation de la Piramide con la textura incorporada pormedio de la funcion del tiempo.
		...
		//Asignamos diferentes transformaciones a las matrices que tenemospreviamente declaradas
		...
		VAO1.Bind();
		// Draw primitives, number of indices, datatype of indices, index ofindices
